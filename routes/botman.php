...
$serviceAccount = ServiceAccount::fromJsonFile(__DIR__.'/Firebase.json');
    ...
    $botman->hears('เปิดแอร์คอนดิชั่น|เปิดแอร์คอนดิชั่นให้หน่อย|เปิดแอร์คอนดิชั่นให้หน่อย|ช่วยเปิดแอร์คอนดิชั่นให้หน่อย|ช่วยเปิดแอร์คอนดิชั่นให้ที', '\MyBotCommands@OnAir1');
