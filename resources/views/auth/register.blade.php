                        ...
                        <div class="form-group row">
                            ...
                            <div  class="col-md-6 ">
                                <select name="sex" id="sex" class="custom-select my-1 mr-sm-2">
                                    <option value="Unspecified" class="form-control">
                                        <label for="Unspecified" class="col-md-4 col-form-label text-md-right">{{ __('Unspecified') }}</label>
                                    </option>
